// widgets/plantillas/carta_renuncia_form1.dart
import 'package:flutter/material.dart';
import 'package:pdf/pdf.dart';
import 'package:pdf/widgets.dart' as pw;
import 'package:printing/printing.dart';

class CartaRenunciaForm1 extends StatefulWidget {
  final Function(Map<String, String>) onFormSubmit;

  const CartaRenunciaForm1({required this.onFormSubmit, Key? key})
      : super(key: key);

  @override
  State<CartaRenunciaForm1> createState() => _CartaRenunciaForm1State();
}

class _CartaRenunciaForm1State extends State<CartaRenunciaForm1> {
